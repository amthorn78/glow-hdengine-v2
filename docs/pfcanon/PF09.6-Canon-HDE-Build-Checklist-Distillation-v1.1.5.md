...
**Current controlling release binding.** The binding is `release_id` plus exactly `artifacts/bodygraph/refresh_policy.snapshot.json`, `artifacts/bodygraph/source_invariance/summary.json` under its in-place v2 contract, and `artifacts/bodygraph/source_selection.snapshot.json`. This controlling set supersedes the earlier minimum-field example above.
