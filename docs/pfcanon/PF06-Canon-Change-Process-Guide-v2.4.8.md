...
* "\<STABLE\_REQUIREMENT\_OR\_CRITERION\_ID\>"

evidence\_minima:

* "\<TEST, CHECK, WORKFLOW, OR GOVERNED ARTIFACT IDENTITY AND PASS/FAIL PREDICATE\>"

candidate\_identity:

* "\<REPOSITORY AND EXACT SHA; INCLUDE PR BASE/HEAD/MERGE IDENTITIES WHEN A PR IS USED\>"
