...
This boundary performs no durable write. Mapped-cache schema choice, write, read-back, idempotence, and authorization remain with the later persistence flow.
