...
- Evidence-path and LF-ending gates: `python tools/evidence/validate_evidence_paths.py` and `python tools/evidence/check_lf_endings.py` (logs captured under `audit/qa/hde-epic027/checks/`).
