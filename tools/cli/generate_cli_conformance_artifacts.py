...
def _capture_outputs() -> dict[Path, bytes]:
    ...
    elif os.environ.get("HDE_ISOLATED_RELEASE_BUILD") == "1":
        # The external release-attestation builder copies tracked source into a
        # scratch checkout without installing console scripts.  Keep the source
        # tree's generated bytes unchanged while validating equivalent module
        # execution inside that isolated exact-head copy.
