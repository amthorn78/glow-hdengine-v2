...
def build_outputs(produced_at: str) -> dict[Path, bytes]:
    ...
    request_shape = {**common, "artifact_kind": "hde_epic037_bg_resolve_request_shape", "input_references": _input_refs(), "inspected_internal_loci": _loci(), "request_shape": {"configured_base_url_key": "HD_API_BASE_URL", "deprecated_base_url_alias": {"env_var": "HDAPI_BASE_URL", "posture": "compatibility alias only; canonical and deprecated conflicts fail closed"}, "resource_path": "charts", "route": request.route, "url": request.url, "no_double_version_prefix": "/v2/v2/" not in request.url, "no_legacy_bodygraph_request_against_v2": "bodygraphs" not in request.url, "auth_header_posture": "Authorization: Bearer <redacted>", "geocode_header_posture": "HD-Geocode-Key: <redacted>", "raw_request_body_emitted": False, "raw_response_body_emitted": False}, "resolver_request_posture": mapped["resolver"]["request"], "tokens": ["ENV_RAILS_POLICY_OK", "JSON_CANONICAL_CHECK_OK", "EVIDENCE_PATH_PROOFS_OK"]}
