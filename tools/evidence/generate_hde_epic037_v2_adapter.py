...
def context(**overrides: str) -> V2ChartAdapterContext:
    values = {"person_uid": "person-epic037-pr02", "user_id": "123e4567-e89b-12d3-a456-426614174000", "vendor": "hdapi", "vendor_version": 2, "input_fingerprint": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "route_family": "recommended_v2_chart", "route": "vendor.hdapi.post:/charts", "payload_family": "ChartResult"}
...
def _negative_cases() -> list[dict[str, Any]]:
    return [
        ...
        {"fixture_id": "malformed_success_envelope_error_code", "result": adapt_v2_chart_payload({"timestamp": "2026-07-05T00:00:00.000Z", "success": True, "message": "Chart generated", "errorCode": None, "type": "ChartResult", "data": chart_result_payload()}, context()).as_dict()},
