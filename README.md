# Glow HD Engine — HDE-EPIC026 final docs sweep
...
- What HDE-EPIC026 clarifies:
  ...
  - Evidence index + mirror discipline includes conjunction-related entries in `docs/evidence/INDEX.json` and `artifacts/evidence_index.jsonl`, with integrity companions for mirror index files (`artifacts/evidence_index.sha256` and path proofs).
  - HDE-EPIC026 close-pack artifacts are generated by `tools/qa/generate_epic026_close_pack.py` and recorded at `audit/EPIC-026_MANIFEST.json`, `audit/EPIC-026_close_report.md`, `audit/qa/hde-epic026/qa_step_logs_manifest.json`, and `audit/docdeltas/hde-epic026_doc_deltas.md`.
...
- Evidence index skeleton includes `artifacts/evidence_index.jsonl` plus integrity companions (`artifacts/evidence_index.sha256`, `artifacts/evidence_index.path_proof.txt`, `artifacts/evidence_index.sha256.path_proof.txt`) alongside docs-side index files.
- HDE-EPIC026 close pack: `python tools/qa/generate_epic026_close_pack.py` writes `audit/EPIC-026_MANIFEST.json`, `audit/EPIC-026_close_report.md`, `audit/qa/hde-epic026/qa_step_logs_manifest.json`, and `audit/docdeltas/hde-epic026_doc_deltas.md`.
...
- EPIC022 acceptance scaffolding: `docs/acceptance_map_epic022.json` and `audit/qa/hde-epic022/token_evidence_matrix.md` bind tokens to evidence and tests; close-pack artifacts live in `audit/EPIC-022_MANIFEST.json` and `audit/EPIC-022_close_report.md`. EPIC024 extends this with a single epic QA root under `audit/qa/hde-epic024/`, map/matrix/viability bindings in `docs/acceptance_map_epic024.json` and `audit/qa/hde-epic024/`, and governed close-pack artifacts in `audit/EPIC-024_MANIFEST.json` and `audit/EPIC-024_close_report.md`.
