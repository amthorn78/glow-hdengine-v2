...
W004_ROUTE_SIGNATURE_CASES = [
    ...
    {
        "case_id": "add-url-rule-omitted-endpoint-dict-name-mutation-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nview.__dict__['__name__'] = 'renamed'\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_endpoint_name",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "add-url-rule-omitted-endpoint-name-delete-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\ndel view.__name__\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_endpoint_name",
    ...
    {
        "case_id": "add-url-rule-dict-view-methods-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nview.__dict__['methods'] = ['POST']\napp.add_url_rule('/x', 'x', view)\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_view_methods",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "add-url-rule-view-methods-delete-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nview.methods = ['POST']\ndel view.methods\napp.add_url_rule('/x', 'x', view)\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_view_methods",
    ...
    {
        "case_id": "add-url-rule-dict-required-methods-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nview.__dict__['required_methods'] = {'OPTIONS'}\napp.add_url_rule('/x', 'x', view, methods=['POST'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_view_methods",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
