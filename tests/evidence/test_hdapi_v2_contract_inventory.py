...
def test_epic034_pr05_closed_rails_refusal_artifacts_are_lf_terminated_and_complete() -> None:
    ...
    for predicate in [
        ...
        "chart_resource_paths_refuse_without_external_io",
        "configured_base_url_version_changes_final_url",
        "no_double_version_prefix",
        "chart_auth_uses_authorization_bearer",
        "chart_does_not_use_hd_api_key_header",
        "legacy_uses_hd_api_key_header",
        "legacy_does_not_use_bearer_auth",
...
W004_ROUTE_SIGNATURE_CASES = [
    ...
    {
        "case_id": "register-blueprint-omitted-prefix-keeps-constructor-prefix",
        "body": "from flask import Flask, Blueprint\napp = Flask(__name__)\nbp = Blueprint('api', __name__, url_prefix='/api')\n@bp.get('/reader')\ndef reader():\n    return b'ok'\napp.register_blueprint(bp)\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "route_decorator",
        "expected_path": "/api/reader",
    ...
    {
        "case_id": "register-blueprint-omitted-plus-prefix-fails-closed",
        "body": "from flask import Flask, Blueprint\napp = Flask(__name__)\nbp = Blueprint('api', __name__, url_prefix='/api')\n@bp.get('/reader')\ndef reader():\n    return b'ok'\napp.register_blueprint(bp, name='default')\napp.register_blueprint(bp, url_prefix='/public', name='public')\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "route_decorator",
        "expected_reason": "multiple_register_blueprint_prefixes",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "register-blueprint-omitted-plus-none-fails-closed",
        "body": "from flask import Flask, Blueprint\napp = Flask(__name__)\nbp = Blueprint('api', __name__, url_prefix='/api')\n@bp.get('/reader')\ndef reader():\n    return b'ok'\napp.register_blueprint(bp, name='default')\napp.register_blueprint(bp, url_prefix=None, name='copy')\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "route_decorator",
        "expected_reason": "multiple_register_blueprint_prefixes",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "add-url-rule-decorated-local-view-fails-closed",
    ...
    {
        "case_id": "add-url-rule-decorated-local-view-explicit-endpoint-fails-closed",
    ...
    {
        "case_id": "add-url-rule-control-flow-rebound-local-view-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\nUSE_ALT = True\ndef view():\n    return b'ok'\ndef other():\n    return b'other'\nif USE_ALT:\n    view = other\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_view_binding",
    ...
    {
        "case_id": "add-url-rule-helper-call-before-registration-fails-closed",
    ...
    {
        "case_id": "add-url-rule-for-target-rebinds-local-view-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\ndef other():\n    return b'other'\nfor view in [other]:\n    pass\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_view_binding",
    ...
    {
        "case_id": "add-url-rule-with-as-rebinds-local-view-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nwith view as view:\n    pass\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_view_binding",
    ...
    {
        "case_id": "add-url-rule-except-as-rebinds-local-view-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\ntry:\n    pass\nexcept Exception as view:\n    pass\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_view_binding",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "add-url-rule-walrus-rebinds-local-view-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\ndef other():\n    return b'other'\n(view := other)\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_view_binding",
    ...
    {
        "case_id": "add-url-rule-delete-unbinds-local-view-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\ndel view\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_view_binding",
    ...
    {
        "case_id": "add-url-rule-match-before-registration-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\ndef other():\n    return b'other'\nmatch {'x': other}:\n    case {'x': view}:\n        pass\napp.add_url_rule('/x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_view_binding",
    ...
    },
    {
        ...
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_endpoint_name",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    },
    {
        "case_id": "add-url-rule-explicit-endpoint-allows-name-mutation",
    ...
    },
    {
        ...
        "body": "from flask import Flask\nfrom views import real_view as v\napp = Flask(__name__)\napp.add_url_rule('/x', view_func=v, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_or_missing_add_url_rule_endpoint_or_view",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    },
    {
        "case_id": "add-url-rule-keyword-endpoint-signed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\napp.add_url_rule('/x', endpoint='x', view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "add_url_rule",
        "expected_path": "/x",
    ...
    {
        "case_id": "add-url-rule-dynamic-keyword-endpoint-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nENDPOINT = 'x'\napp.add_url_rule('/x', endpoint=ENDPOINT, view_func=view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_endpoint",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    },
    {
        "case_id": "add-url-rule-dotted-view-omitted-endpoint-fails-closed",
        "body": "from flask import Flask\nimport module\napp = Flask(__name__)\napp.add_url_rule('/x', view_func=module.view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_or_missing_add_url_rule_endpoint_or_view",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "add-url-rule-dotted-view-explicit-endpoint-supported",
        "body": "from flask import Flask\nimport module\napp = Flask(__name__)\napp.add_url_rule('/x', 'view', module.view, methods=['GET'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "add_url_rule",
        "expected_path": "/x",
        "expected_endpoint": "view",
        "expected_view_identity": "module.view",
        "expected_methods": ("GET",),
        "expected_classification": "public",
    },
    {
        "case_id": "add-url-rule-dotted-view-omitted-methods-fails-closed",
        "body": "from flask import Flask\nimport module\napp = Flask(__name__)\napp.add_url_rule('/x', 'x', module.view)\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_add_url_rule_methods",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    },
    {
    ...
    {
        "case_id": "add-url-rule-static-view-methods-override-default-get",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nview.methods = ['POST']\napp.add_url_rule('/x', 'x', view)\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "add_url_rule",
        "expected_path": "/x",
    ...
    {
        "case_id": "add-url-rule-stale-view-methods-before-function-ignored",
        "body": "from flask import Flask\napp = Flask(__name__)\nclass Holder:\n    pass\nview = Holder()\nview.methods = ['POST']\ndef view():\n    return b'ok'\napp.add_url_rule('/x', 'x', view)\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "add_url_rule",
        "expected_path": "/x",
    ...
    {
        "case_id": "add-url-rule-helper-view-methods-do-not-override",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\ndef configure():\n    view.methods = ['POST']\napp.add_url_rule('/x', 'x', view)\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "add_url_rule",
        "expected_path": "/x",
    ...
    {
        "case_id": "add-url-rule-static-required-methods-augment-default-get",
    ...
    {
        "case_id": "add-url-rule-static-required-methods-augment-explicit-methods",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nview.required_methods = {'OPTIONS'}\napp.add_url_rule('/x', 'x', view, methods=['POST'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "add_url_rule",
        "expected_path": "/x",
        "expected_endpoint": "x",
        "expected_view_identity": "view",
        "expected_methods": ("OPTIONS", "POST"),
        "expected_classification": "public",
    },
    {
        "case_id": "add-url-rule-dynamic-required-methods-fails-with-explicit-methods",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nREQ = {'OPTIONS'}\nview.required_methods = REQ\napp.add_url_rule('/x', 'x', view, methods=['POST'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "dynamic_add_url_rule_view_methods",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "add-url-rule-explicit-methods-ignore-view-methods",
        "body": "from flask import Flask\napp = Flask(__name__)\ndef view():\n    return b'ok'\nview.methods = ['GET']\napp.add_url_rule('/x', 'x', view, methods=['POST'])\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_SUPPORTED,
        "expected_kind": "add_url_rule",
        "expected_path": "/x",
    ...
    {
        "case_id": "methodview-nonlocal-omitted-methods-fails-closed",
        "body": "from flask import Flask\nimport views\napp = Flask(__name__)\napp.add_url_rule('/external', view_func=views.External.as_view('external_view'))\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_methodview_binding",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    },
    {
        "case_id": "methodview-custom-as-view-fails-closed",
        "body": "from flask import Flask\napp = Flask(__name__)\nclass Custom:\n    def get(self):\n        return b'ok'\n    @classmethod\n    def as_view(cls, name):\n        def view():\n            return b'ok'\n        return view\napp.add_url_rule('/custom', view_func=Custom.as_view('custom_view'))\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_methodview_binding",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    ...
    {
        "case_id": "methodview-empty-methods-fails-closed",
        "body": "from flask import Flask\nfrom flask.views import MethodView\napp = Flask(__name__)\nclass Empty(MethodView):\n    pass\napp.add_url_rule('/empty', view_func=Empty.as_view('empty_view'))\n",
        "expected_status": boundary_analyzer.BOUNDARY_ROUTE_AMBIGUOUS,
        "expected_kind": "add_url_rule",
        "expected_reason": "unproven_methodview_methods",
        "expected_classification": boundary_analyzer.BOUNDARY_UNKNOWN,
    },
    {
